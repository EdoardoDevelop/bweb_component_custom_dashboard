    ...
    public function bccustom_dashboard_load_scripts_admin(){
		...
		if(isset($_GET['page'])):
			if($pagenow=='admin.php' && $_GET['page']=='custom_dashboard'){
				...
				add_thickbox();
				wp_enqueue_media();
				wp_enqueue_script( 'jquery-ui-touch', plugin_dir_url(DIR_COMPONENT .  '/bweb_component_functions/').'custom_dashboard/assets/jquery.ui.touch-punch.min.js', array( 'jquery' ), null, true );
				wp_enqueue_script( 'dashjs', plugin_dir_url(DIR_COMPONENT .  '/bweb_component_functions/').'custom_dashboard/assets/script.js', array( 'jquery' ), null, true );
				wp_enqueue_style( 'dashcss', plugin_dir_url( DIR_COMPONENT .  '/bweb_component_functions/' ).'custom_dashboard/assets/style.css');
